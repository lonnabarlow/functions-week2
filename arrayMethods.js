...
// // CODE HERE
const totalPopulation = populations.reduce(function(runningTotal, curVal){
...
const totalOrders = orders.map(function(element){
...
// */
const bobsPurchases = purchases.filter(function(element){
  return element["owner"] === "Bob"
}).reduce(function(runningTotal, element){
    return runningTotal + element["price"]
}, 0)
